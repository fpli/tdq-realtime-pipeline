...
public class Field extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7741724364719644304L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Field\",\"namespace\":\"com.ebay.dap.tdq.common.model.avro\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"value\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static BinaryMessageEncoder<Field> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a Field instance decoded from the given buffer
   ...
   */
  public Field(java.lang.String type, java.lang.String value) {
    this.type = type;
    this.value = value;
  }
   ...
   */
  public static com.ebay.dap.tdq.common.model.avro.Field.Builder newBuilder() {
    return new com.ebay.dap.tdq.common.model.avro.Field.Builder();
  }
   ...
   * @return A new Field RecordBuilder
   */
  public static com.ebay.dap.tdq.common.model.avro.Field.Builder newBuilder(com.ebay.dap.tdq.common.model.avro.Field.Builder other) {
    if (other == null) {
      return new com.ebay.dap.tdq.common.model.avro.Field.Builder();
    } else {
      return new com.ebay.dap.tdq.common.model.avro.Field.Builder(other);
    }
  }
   ...
   * @return A new Field RecordBuilder
   */
  public static com.ebay.dap.tdq.common.model.avro.Field.Builder newBuilder(com.ebay.dap.tdq.common.model.avro.Field other) {
    if (other == null) {
      return new com.ebay.dap.tdq.common.model.avro.Field.Builder();
    } else {
      return new com.ebay.dap.tdq.common.model.avro.Field.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Field>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ebay.dap.tdq.common.model.avro.Field.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ebay.dap.tdq.common.model.avro.Field other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.dap.tdq.common.model.avro.Field.Builder setType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.dap.tdq.common.model.avro.Field.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.dap.tdq.common.model.avro.Field.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.dap.tdq.common.model.avro.Field.Builder clearValue() {
      value = null;
